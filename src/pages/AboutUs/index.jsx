...
export default function AboutUs() {
  return (
    <div className="aboutUs__container">
      ...
      <div className="zetsyIntroduction">
        <h1>
          "Since the start of the
          <br /> Zetsy journey, we aim to continue
          <br /> to merge our backgrounds in
          <br /> technology and integrations
          <br /> to create web to human
          <br />
          essentials, right here in the Nepal."
        </h1>
        <div>
          ...
          <p>
            ...
            officiis sapiente corrupti dolorum quibusdam consequatur cumque,
            voluptatibus soluta vel explicabo sit provident beatae veritatis
            temporibus voluptatem dolore quam consequuntur. Tenetur!
            <br />
            <br />
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Eaque
            officiis sapiente corrupti dolorum quibusdam consequatur cumque,
